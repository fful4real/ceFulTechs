...
// Returns the private 'App\Repository\CeAccountTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeAccountTypeRepository.php';

return $this->privates['App\Repository\CeAccountTypeRepository'] = new \App\Repository\CeAccountTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
