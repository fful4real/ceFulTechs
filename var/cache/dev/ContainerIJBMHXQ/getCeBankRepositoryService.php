...
// Returns the private 'App\Repository\CeBankRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeBankRepository.php';

return $this->privates['App\Repository\CeBankRepository'] = new \App\Repository\CeBankRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
