...
// Returns the private 'App\Repository\CeStatusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeStatusRepository.php';

return $this->privates['App\Repository\CeStatusRepository'] = new \App\Repository\CeStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
