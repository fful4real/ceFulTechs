...
// Returns the private 'App\Repository\OrderTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\OrderTypeRepository.php';

return $this->privates['App\Repository\OrderTypeRepository'] = new \App\Repository\OrderTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
