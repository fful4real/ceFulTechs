...
// Returns the private 'App\Repository\CeUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeUserRepository.php';

return $this->privates['App\Repository\CeUserRepository'] = new \App\Repository\CeUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
