...
// Returns the private 'App\Repository\CeChargeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeChargeRepository.php';

return $this->privates['App\Repository\CeChargeRepository'] = new \App\Repository\CeChargeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
