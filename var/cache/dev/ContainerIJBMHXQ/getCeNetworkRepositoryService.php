...
// Returns the private 'App\Repository\CeNetworkRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeNetworkRepository.php';

return $this->privates['App\Repository\CeNetworkRepository'] = new \App\Repository\CeNetworkRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
