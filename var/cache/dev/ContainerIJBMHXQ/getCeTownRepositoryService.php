...
// Returns the private 'App\Repository\CeTownRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeTownRepository.php';

return $this->privates['App\Repository\CeTownRepository'] = new \App\Repository\CeTownRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
