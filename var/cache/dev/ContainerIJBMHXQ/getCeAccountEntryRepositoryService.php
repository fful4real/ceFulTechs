...
// Returns the private 'App\Repository\CeAccountEntryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeAccountEntryRepository.php';

return $this->privates['App\Repository\CeAccountEntryRepository'] = new \App\Repository\CeAccountEntryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
