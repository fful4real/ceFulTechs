...
// Returns the private 'App\Repository\CeCustomerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeCustomerRepository.php';

return $this->privates['App\Repository\CeCustomerRepository'] = new \App\Repository\CeCustomerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
