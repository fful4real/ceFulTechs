...
// Returns the private 'App\Repository\CeBankTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeBankTypeRepository.php';

return $this->privates['App\Repository\CeBankTypeRepository'] = new \App\Repository\CeBankTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
