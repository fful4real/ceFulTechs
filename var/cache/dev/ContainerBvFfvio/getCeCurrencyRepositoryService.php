...
// Returns the private 'App\Repository\CeCurrencyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeCurrencyRepository.php';

return $this->privates['App\Repository\CeCurrencyRepository'] = new \App\Repository\CeCurrencyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
