...
// Returns the private 'App\Repository\CeorderRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeorderRepository.php';

return $this->privates['App\Repository\CeorderRepository'] = new \App\Repository\CeorderRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
