...
// Returns the private 'App\Repository\CeAccountRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CeAccountRepository.php';

return $this->privates['App\Repository\CeAccountRepository'] = new \App\Repository\CeAccountRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
